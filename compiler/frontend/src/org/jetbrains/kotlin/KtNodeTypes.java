...
public interface KtNodeTypes {
    ...
    ILazyParseableElementType LAMBDA_EXPRESSION = new IReparseableElementType("LAMBDA_EXPRESSION", KotlinLanguage.INSTANCE) {
        @Override
        ...
        public boolean isParsable(CharSequence buffer, Language fileLanguage, Project project) {
            // TODO: Check IErrorCounterReparseableElementType as better implementation
            if (fileLanguage != KotlinLanguage.INSTANCE) return false;
            return true;
        }
    };
