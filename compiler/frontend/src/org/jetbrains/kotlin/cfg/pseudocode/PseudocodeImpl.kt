...
class PseudocodeImpl(override val correspondingElement: KtElement) : Pseudocode {
    ...
    private fun repeatInternal(
        ...
        val originalToCopy = Maps.newLinkedHashMap<PseudocodeLabel, PseudocodeLabel>()
    ...
    private fun repeatLabelsBindingForInstruction(
            ...
            originalToCopy: Map<out Label, PseudocodeLabel>,
    ...
    private fun copyInstruction(instruction: Instruction, originalToCopy: Map<out Label, PseudocodeLabel>): Instruction {
    ...
    private fun copyLabels(labels: Collection<Label>, originalToCopy: Map<out Label, PseudocodeLabel>): MutableList<Label> {
