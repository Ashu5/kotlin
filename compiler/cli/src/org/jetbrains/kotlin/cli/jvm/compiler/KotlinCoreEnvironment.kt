...
class KotlinCoreEnvironment private constructor(
    ...
    fun updateClasspath(files: Iterable<File>): List<File>? {
        return rootsIndex.addNewIndexForRoots(files.map(::JvmClasspathRoot).classpathRoots())?.let {
    ...
    fun tryUpdateClasspath(files: Iterable<File>): List<File>? = updateClasspath(files)
